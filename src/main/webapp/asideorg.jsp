...
<html>
	<body>
		<aside id="all-aside" class="bg-verde">
			<div class="col bg-verde text-white">
	          <div class="bg-verde" style="text-align: justify;">
	            <h5><i class="bi bi-check"></i>Assembleia Geral</h5>
	            <hr/>
	          </div>
	          <br>
	          <div class="bg-verde" style="text-align: justify;">
	            <h5><i class="bi bi-check"></i><a href="/diretoria.jsp" style="text-decoration: none; color: white;">Diretoria </a></h5> 
	            <hr/>
	          </div>
	          <br>
	          <div class="bg-verde" style="text-align: justify;">
	            <h5><i class="bi bi-check"></i><a href="/conselhofiscal.jsp" style="text-decoration: none; color: white;">Conselho Fiscal </a></h5> 
	            <hr/>
	          </div>
	          <br>
	          <div class="bg-verde" style="text-align: justify;">
	          ...
	          <br>
	          <div class="bg-verde" style="text-align: justify;">
	            <h5><i class="bi bi-check"></i>Diretoria Adjunta </h5> 
	            <h6></h6>
	            <hr/>
	          </div>
	          <br>
