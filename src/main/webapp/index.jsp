			    ...
			    <div class="collapse navbar-collapse justify-content-center sticky-top bg-laranja text-dark" id="navbarNavDropdown">
			      <ul class="navbar-nav">
			        <li class="nav-item dropdown">
			          ...
			          <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
			            <li><a class="dropdown-item" href="#"><strong>CLARA AMIZADE</strong></a></li>
			        ...
			        <li class="nav-item dropdown">
			          ...
			          <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
			            ...
			            <li><a class="dropdown-item" href="#">Doação de Produtos</a></li>
			            <li><a class="dropdown-item" href="#">Doação de Bens</a></li>
