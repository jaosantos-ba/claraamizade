			...
			<div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel">
			  ...
			  <!-- <div class="carousel-item">
			   ...
			   <!-- <div class="carousel-item active">
			    ...
			    <div class="carousel-item">
			      <a href="https://www.youtube.com/ClaraAmizade" target="_blank"><img src="./img/index/carrossel06_youtube.png" class="d-block imagem-carrossel1" style="width: 100%; height: 100%;" alt="..."></a>
			      <div class="carousel-caption d-none d-md-block">
			        <h5></h5>
			        <p></p>
			      </div>
