...
<html>
	...
	<body>
			    ...
			    <div class="collapse navbar-collapse justify-content-center sticky-top bg-laranja text-dark" id="navbarNavDropdown">
			      <ul class="navbar-nav">
			        ...
			        <li class="nav-item dropdown">
			          ...
			          <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
			            <li><a class="dropdown-item" href="#"><strong>PARTICIPE</strong></a></li>
			            <li><a class="dropdown-item" href="#">Doe agora</a></li>
			            <li><a class="dropdown-item" href="#">Doação de produtos/bens</a></li>
			            <li><a class="dropdown-item" href="#">Doação com Incentivo Fiscal</a></li>
			            <li><a class="dropdown-item" href="#">Nota Premiada Bahia</a></li>
			            <li><a class="dropdown-item" href="#">Seja voluntário</a></li>
			            <li><div class="dropdown-divider"></div></li>
			            <li><a class="dropdown-item" href="#"><strong>SÓCIO CONTRIBUINTE</strong></a></li>
			            <li><a class="dropdown-item" href="#">Seja um sócio contribuinte</a></li>
			            <li><a class="dropdown-item" href="#">Benefícios do sócio contribuinte</a></li>
			            <li><div class="dropdown-divider"></div></li>
			            <li><a class="dropdown-item" href="#"><strong>CAMPANHAS</strong></a></li>
			            <li><a class="dropdown-item" href="#">Padrinho Amigo</a></li>
			            <li><a class="dropdown-item" href="#">Parceiro Amigo</a></li>
			          </ul>
			        </li>
			        <li class="nav-item dropdown">
			          <a class="nav-link dropdown-toggle text-white fs-5" href="#" id="navbarDropdownMenuLink" role="button" data-bs-toggle="dropdown" aria-expanded="false">
			          ...
			          <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
			            ...
			            <li><a class="dropdown-item" href="#">Demonstrações Contábeis</a></li>
			          </ul>
			        </li>
			        <li class="nav-item">
		...
		<footer id="main-footer">
			...
			<div class="container">
				<div class="container">
					<h2 class="pb-2 text-center">Siga a Clara Amizade</h2>
					<div class="row align-items-center">
			...
			<div class="bg-laranja">
				<div class="container bg-laranja">
				<br>
					...
					<ul>
						...
						<li class="footer-lista">
							<a class="footer-lista" title="Quem somos" href=""><small>Parcerias Públicas</small></a>
						</li>
						<li class="footer-lista">
							<a class="footer-lista" title="Quem somos" href=""><small>Parcerias Privadas</small></a>
						</li>
					</ul>
					<ul>
						<li class="footer-lista">
					...
					<div class="row align-items-center">
					  ...
					  <hr>
						<div class="row text-center">
							...
							<div class="col text-center">
								<iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d15553.4417214319!2d-38.380044!3d-12.948773!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0xe0f5ee7792bfb1d1!2sClara%20Amizade!5e0!3m2!1spt-BR!2sbr!4v1624756134490!5m2!1spt-BR!2sbr" width="400" height="300" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
							</div>
						</div>
						<br>
				</div>
