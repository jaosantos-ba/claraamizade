	...
	<body>
		...
		<nav class="navbar-light bg-verde ">
		  <div class="container text-white">
		    ...
		    <i class="bi bi-arrow-right-short"></i>
		    <a class="navbar-brand text-white fw-bold fs-6">Matrículas</a>
		  </div>
		</nav>
		...
		<main id="parcpriv-main">
			...
			<div class="container">
			  <br>
		      <div class="">
		        <h1 class="">Matrículas 2022</h1>
		        <p class="" style="text-align: justify;">Estão abertas as matrículas para as atividades 2022 da Associação Clara Amizade. A partir do dia 11 de janeiro, novas educandas e educandos podem se matricular nas oficinas socioeducativas e cursos profissionalizantes que compõem o nosso Programa de Educação Global e Capacitação Profissional. Educandas e educandos que participaram das atividades em 2021 e não se rematricularam também são convidados a comparecer para garantir participação neste ano.</p>
		      </div>
